...
CUTLASS_DEVICE uint32_t atomic_add_acq_rel_sys(const uint32_t* ptr, const uint32_t& value) {
    uint32_t ret;
...
CUTLASS_DEVICE uint32_t atomic_add_acq_rel_gpu(const uint32_t* ptr, const uint32_t& value) {
    uint32_t ret;

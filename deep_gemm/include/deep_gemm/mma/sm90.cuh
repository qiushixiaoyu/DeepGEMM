...
struct FP8MMARS {
    ...
    template <size_t ...Idx>
    CUTLASS_DEVICE static void call_fma_impl(uint32_t a0, uint32_t a1, uint32_t a2, uint32_t a3,
    ...
    CUTLASS_DEVICE static void wgmma(uint32_t a0, uint32_t a1, uint32_t a2, uint32_t a3,
                                     uint64_t const& desc_b, float* d, bool scale_d) {
